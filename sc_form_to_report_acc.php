						   ...
						   <div class="col-lg-12 border border border-dark">
								...
								<div class="row canvas_div_pdf" id="printableArea">
									<div class="col-lg-12">
										...
										<div class="row mt-3 text-uppercase d-flex justify-content-center">
											<center>[মোটরযান অধ্যাদেশ ১৯৮৩-এর ৪০(১) ধারা এবং মোটরযান বিধি ১৯৮৪-এর ৬৪(১) বিধি]<br>মোটরযানের মালিকানা বদলি</center>
									    </div>
										<br> 
										
										<div class="row mt-2 d-flex justify-content-left">
											আমি /আমরা -<?php echo 'RANGS MOTORS LIMITED';?>
									    </div>
										<!--
										<div class="row mt-2 d-flex justify-content-left">
										...
										-->
										<div class="row mt-2 d-flex justify-content-left">
											ঠিকানা - <?php echo '117/A,LEVEL-04,OLD AIRPORT ROAD,DHAKA-1215.';?> 
									    </div><br>
										<div class="row mt-2 d-flex justify-content-left">
										      এতদসঙ্গে গাড়ি নং - <?php echo ''.$V_REG_NO.' ';?> 
									    </div>
										<div class="row mt-2 d-flex justify-content-left">
								                                ধরন--------------------------------, প্রস্তুতকাল/প্রস্তুতকারক------------------এর
								        </div>
										<div class="row mt-2 d-flex justify-content-left">
								   ...
								   <div class="row mt-2 d-flex justify-content-left">
									রেজিস্ট্রেশন সার্টিফিকেট এবং ফিটনেস সার্টিফিকেট,রুট পারমিট
									</div>
									<div class="row mt-2 d-flex justify-content-left">
									টেক্সটোকেন এবং ইন্সুরেন্স সার্টিফিকেট সংযুক্ত করিয়া জনাব <?php echo ''.$V_BANK_NAME.' ';?> 
									</div>
									<div class="row mt-2 d-flex justify-content-left">
									 পিতা / স্বামী ----------------------------------------------------------------------------------
									</div>
								...
								<br>
								<div class="row mt-2 d-flex justify-content-left">
								কতৃক আমি/আপনার নিকট হস্তান্তরকৃত উপরে উল্লেখিত গাড়ীটির নাম মালিকানা আমি আমাদের অনুকূলে বদলি তথা (রেজিস্ট্রেশন )করিবার অনুরোধ জানাইতেছি।
								</div>
