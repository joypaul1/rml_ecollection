	  ...
	  <div class="container-fluid">
		...
		if(isset($_POST['user_name'])){                
				...
				if($password!=$again_password){                 
					...
					values(9,'$user_id','$user_name','$user_mail','$password','ALL','$original_password','$emp_session_id',CURDATE())";
									...
									<li class="breadcrumb-item">
									  ...
									  <?php	
										 ...
										 while($stuff){	
											...
											echo "<script>window.location = 'http://202.40.181.98:9090/rangs_collection_rml/user_list_callsystem.php'</script>";
									   ?>
									</li>
								   </ol>
								  </div>
