							...
							<table class="table table-bordered piechart-key" id="admin_list" style="width:100%">
								<thead class="thead-dark">
									<tr>
										...
										<th scope="col">
											<center>Admin Remarks</center>
										</th>
										<th scope="col">
											<center>Customer Remarks</center>
										</th>
										<th scope="col">
											<center>Entry Date</center>
										</th>
										<th scope="col">
											<center>Entry By</center>
										</th>
										<th scope="col">
											<center>Open/Close</center>
										</th>
										<th scope="col">
											<center>Call Category</center>
										</th>
									</tr>
								</thead>
								...
								<tbody>
									...
									if (isset($_POST['ref_code'])) {
										...
										AND ('$ref_code' IS NULL OR CHASSIS_NO='$ref_code')
										...
										while ($row = oci_fetch_assoc($strSQL)) {
											...
											<tr>
												...
												<td>
													<?php
													echo '<i style="color:blue;"><b>' . $row['CHASSIS_NO'] . '</b></i> ';
													?>
												</td>
												<td>
													<?php
													echo '<i style="color:blue;"><b>' . $row['ENG_NO'] . '</b></i> ';
													?>
												</td>
												<td>
													<?php
													echo '<i style="color:blue;"><b>' . $row['REF_CODE'] . '</b></i> ';
													?>
												</td>

												<td><?php echo $row['ENTRY_REMARKS']; ?></td>
										...
										UPDATED_DATE,
										b.CALL_CATEGORY_TITLE
										FROM DEVELOPERS.CCD_CALL a,RML_COLL_CALL_CATEGORY b
										WHERE a.RML_COLL_CALL_CATEGORY_ID=B.ID
										and CLOSE_STATUS=0
										and CALL_TYPE='OUT'
										and a.ENTRY_BY='$emp_session_id'
