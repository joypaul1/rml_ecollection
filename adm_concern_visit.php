    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="">Concern Visit Summary</a>
        </li>
      </ol>
	  <div class="container-fluid">
			<div class="row">
					  ...
					  <table class="table table-striped table-bordered table-sm" id="table" cellspacing="0" width="100%"> 
						<thead class="thead-dark">
								<tr>
								  ...
								  <th scope="col"><center>Unique Visited</center></th>
							...
							if(($_SESSION['user_role_id'] == 3)){
								 $strSQL  = oci_parse($objConnect, 
										   "SELECT A.RML_ID,
												...
												A.CONCERN,
												VISIT_UNIT,
												COLL_VISIT_TOTAL(B.ID,TO_DATE('$attn_start_date','DD/MM/YYYY'),TO_DATE('$attn_end_date','DD/MM/YYYY')) TOTAL_VISITED,
												COLL_VISIT_UNIQUE_TOTAL(B.ID,TO_DATE ('$attn_start_date', 'DD/MM/YYYY'),TO_DATE ('$attn_end_date', 'DD/MM/YYYY'))VISIT_UNIQUE_TOTAL,
												COLL_SUMOF_COLLECTION(B.RML_ID,TO_DATE('$attn_start_date','DD/MM/YYYY'),TO_DATE('$attn_end_date','DD/MM/YYYY')) COLLECTION_AMNT 
							 ...
							 $strSQL  = oci_parse($objConnect, 
										   "SELECT A.RML_ID,A.TARGET,A.CONCERN,
													VISIT_UNIT,COLL_VISIT_TOTAL(B.ID,TO_DATE('$attn_start_date','DD/MM/YYYY'),TO_DATE('$attn_end_date','DD/MM/YYYY')) TOTAL_VISITED,
													COLL_VISIT_UNIQUE_TOTAL(B.ID,TO_DATE ('$attn_start_date', 'DD/MM/YYYY'),TO_DATE ('$attn_end_date', 'DD/MM/YYYY'))VISIT_UNIQUE_TOTAL,
												   COLL_SUMOF_COLLECTION(B.RML_ID,TO_DATE('$attn_start_date','DD/MM/YYYY'),TO_DATE('$attn_end_date','DD/MM/YYYY')) COLLECTION_AMNT 
										 FROM MONTLY_COLLECTION A, RML_COLL_APPS_USER B
										WHERE A.RML_ID=B.RML_ID
