                                    ...
                                    while ($row = @oci_fetch_assoc($strSQL)) {
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <?php 
                                                // echo $row['USER_TYPE'];
                                                if ($row['USER_TYPE'] === "C-C") {
                                                    echo '<button class="btn btn-sm btn-gradient-info" type="submit">Col. Concern</button>';
                                                }
                                                else {
                                                    echo ' <button class="btn btn-sm btn-gradient-success" type="submit">S-C Concern</button>';
                                                } ?>
                                            </td>
                                            <td align="center">
