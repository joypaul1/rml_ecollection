					...
					<div class="md-form mt-2">
						...
						<div class="row canvas_div_pdf" id="printableArea">
							<div class="col-lg-12">
								...
								<div class="row mt-2 d-flex justify-content-left">
									ঠিকানা -
									<?php echo '117/A,(LEVEL-4),OLD AIRPORT ROAD,BIJOY SHARANI,TEJGAON,DHAKA.'; ?>
								</div>
								<br>
								<div class="row mt-2 d-flex justify-content-left">
									নমুনা স্বাক্ষর (১)
								...
								<div class="row mt-2 d-flex justify-content-left">
									এর নিকট হস্তান্তর করিয়াছি এবং গাড়ীটির মালিকানা তাহার অনুকূলে বদলি করিবার জন্য অনুরোধ
									জানাইতেছি।
								</div>
								<br><br>
								<div class="row mt-2 d-flex justify-content-left">
									<p>
										<br> তারিখ :<?php echo ' ' . $V_SYSDATE; ?>
									</p>
								</div>
