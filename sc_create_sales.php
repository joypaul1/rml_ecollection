	...
	<div class="container-fluid">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<input name="ref_code" required="" form="Form1" class="form-control" type='text'
				...
				if (isset($_POST['ref_code'])) {
					...
					$strSQL = oci_parse($objConnect, "select REF_CODE,
													...
													where  (BUYERSNO='$ref_code' OR CHASSIS_NO='$ref_code')
									...
									<div class="row">
										...
										<div class="col-sm-12 mt-3 input-lg">
											<b>01. RML Code
												No:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:70%;" form="Form2" type="text" id="title" name="ref_code_no"
												value="<?php echo $ref_code; ?>" readonly>
										</div>

										<div class="col-sm-12 mt-3 input-lg">
											<b>02. Customer Name</b>(Current Party):&nbsp;&nbsp;&nbsp;&nbsp;
											<input class="input-lg" style="width:70%;" type="text" name="cust_name"
										...
										<div class="col-sm-12 mt-3 input-lg">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:70%;" name="cust_mobile" type="text"
												value="<?php echo $customer_mobile_no; ?>">
										</div>
										<div class="col-sm-12 mt-3 input-lg">
											<b>05. Product Type</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:70%;" type="text" value="<?php echo $product_type; ?>"
												readonly>
										</div>
										<div class="col-sm-12 mt-3 input-lg">
											<b>06. Product
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:70%;" type="text" value="<?php echo $modle_name; ?>"
												readonly>
										</div>
										<div class="col-sm-12 mt-3 input-lg">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:70%;" type="text" value="<?php echo $delivery_date; ?>"
												readonly>
										</div>
										<div class="col-sm-12 mt-3 input-lg">
											<b>08. Cloded Date</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:70%;" type="text" value="<?php echo $file_cloded_date; ?>"
												readonly>
										</div>
										<div class="col-sm-12 mt-3 input-lg">
											<b>9. Chassis No</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:70%;" type="text" name="chassis_number"
												value="<?php echo $chs_no; ?>" form="Form2" readonly>
										</div>
										<div class="col-sm-12 mt-3 input-lg">
											<b>10. Engine No</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<div class="col-sm-12 mt-3 input-lg">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:70%;" type="text" value="<?php echo $collection_concern; ?>"
												readonly>
										</div>
										<div class="col-sm-12 mt-3 input-lg">
											<b>13. Sales Amount</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:70%;" type="text" value="<?php echo $sales_amount; ?>"
												readonly>
										</div>
										<div class="col-sm-12 mt-3 input-lg">
											...
											<input style="width:70%;" type="text"
												value="<?php echo $total_received_amount; ?>" readonly>
										</div>
										<div class="col-sm-12 mt-3 input-lg">
											<b>15. Due Amount</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:70%;" type="text" value="<?php echo $due_amount; ?>"
												readonly>
										</div>
										...
										<div class="col-sm-12 mt-3 margin-left">
											...
											<input style="width:20%;" type="text"
												value="<?php echo $TOTAL_DELAY_INTEREST; ?>">
										</div>
										<div class="col-sm-12 mt-3 margin-left">
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<b>ii) Total Delay Received</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input style="width:20%;" type="text"
												value="<?php echo $RECEIVE_DELAY_INTEREST; ?>">
										</div>
										<div class="col-sm-12 mt-3 margin-left">
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<b>iii) Closing Fee</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<div class="row">
											<div class="col-sm-3">
												<div class="form-group">
													...
													<input required="" type="text" name="requester_name" class="form-control"
														id="title" form="Form2">
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													...
													<input required="" type="tel" name="reqst_mobile" class="form-control"
														id="title" form="Form2">
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													...
													<input class="form-control btn btn-primary" type="submit"
														value="Request Create" form="Form2">
												</div>
											</div>
										</div>
			...
			if (isset($_POST['requester_name'])) {
				$strSQL = oci_parse(
					$objConnect,
					"begin RML_COLL_SC_CREATE('$chassish_number','$requester_name','$reqst_mobile','$emp_session_id','CSH'); END;"
				);
