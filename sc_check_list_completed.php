						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
								  ...
								  <input name="ref_code" required=""  class="form-control"  type='text' value='<?php echo isset($_POST['ref_code']) ? $_POST['ref_code'] : ''; ?>' />
								</div>
							</div>
					   ...
					   <table class="table table-bordered border-primary" id="admin_list" style="width:100%">  
						<thead class="thead-dark">
								<tr>
								  ...
								  <th scope="col"><center>Approval Sheet Print</center></th>
								</tr>
					   </thead>
		                  ...
		                  while($row=oci_fetch_assoc($strSQL)){	
						   ...
						   <td><?php echo $number;?></td>
							...
							<td align="center">
                               ...
                               <a href="sc_closing_approval_sheet_report.php?sc_id=<?php echo $row['ID'] ?>"><?php
								echo '<button class="btn btn-danger btn-sm" title="Closing Approval Sheet">&nbsp;&nbsp;A.S &nbsp;&nbsp;</button>';
								?></a> 
								<a href="sc_closing_approval_sheet_rsv_report.php?sc_id=<?php echo $row['ID'] ?>"><?php
								echo '<button class="btn btn-danger btn-sm" title="Closing Approval Sheet(rsv)">&nbsp;RSV&nbsp;&nbsp;</button>';
								?></a>
								<br><br>
								<a  href="sc_closing_approval_sheet_crsv_report.php?sc_id=<?php echo $row['ID'] ?>"><?php
