					...
					<form id="Form2" action="" method="post"></form>
						<div class="row">
							...
							<select required="" name="emp_id" class="form-control" form="Form1">
								 <option selected value="">Select Collection Concern</option>
								      <?php
						...
						if(isset($_POST['emp_id'])){
						  ...
						  $strSQL  = oci_parse($objConnect, "select ID,RML_ID,
																	...
																	CREATED_DATE,
																	LEASE_USER,
																	USER_FOR,AREA_ZONE AS ZONE_NAME,IEMI_NO,
																	 (SELECT COLL_SUMOF_TARGET_AMOUNT(RML_ID,LEASE_USER,USER_FOR) from dual) TERGET_COLLECTION,
																	 COLL_VISIT_UNIT(RML_ID,'','') AS VISIT_UNIT
							...
							<div class="container">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="row">
											...
											<div class="col-sm-3">
												<div class="form-group">
												  ...
												  <input type="text" class="form-control" id="title" name="mobile_no" value= "<?php echo $row['MOBILE_NO'];?>" form="Form2">
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
										...
										<div class="col-sm-3">
												<div class="form-group">
												  ...
												  <select required="" name="form_zone_name" class="form-control" form="Form2">
															  <?php
											$strSQLA  = oci_parse($objConnect, 
											"select distinct(ZONE) AS AREA_ZONE_NAME from MONTLY_COLLECTION 
												  where  is_active=1
												  order by ZONE"); 
																oci_execute($strSQLA);
															   ...
															   while($rowdata=oci_fetch_assoc($strSQLA)){
																       ...
																       if($row['ZONE_NAME']==$rowdata['AREA_ZONE_NAME']){
																	  ?> 
										...
										<div class="col-sm-3">
												<div class="form-group">
												  <label for="title">Target(Current Month):</label>
												  <input type="text" class="form-control" id="title" name="target_amount" value= "<?php echo $row['TERGET_COLLECTION'];?>" form="Form2">
												</div>
										</div>
										<div class="col-sm-3">
												<div class="form-group">
