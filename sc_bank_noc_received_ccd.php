			...
			<div class="row">
					   ...
					   <table class="table table-bordered piechart-key" id="admin_list" style="width:100%">  
						<thead class="thead-dark">
								<tr>
								  ...
								  <th scope="col"><center>NOC Requisition Info</center></th>
								  <th scope="col"><center>NOC Approval Accounts</center></th>
						...
						if(isset($_POST['ref_code'])){
						    ...
						    $strSQL  = oci_parse($objConnect, 
						             "SELECT 
									   ...
									   CCD_APPROVAL_STATUS, 
									   FILE_CLEAR_STATUS,
									   BANK_REQUISITION_STATUS,
									   BANK_REQUISITION_DATE,
									   BANK_REQUISITION_BY,
						 ...
						 <?php
						   ...
						   <tr>
							<td></td>
							<td>
							<input class="btn btn-primary btn pull-right" type="submit" name="submit_approval" value="Bank NOC Received"/>	
							</td>
							<td></td>
							<td></td>
							<td></td>
						  ...
						  while($row=oci_fetch_assoc($allDataSQL)){	
						   ...
						   <tr>
							...
							<td align="center">
							  ...
							  <td align="center">
								  <?php if($row['BANK_REQUISITION_STATUS']=='1'){
									  echo '<i style="color:blue;"><b>Approved</b></i> ';
									  echo '<br>';
									  echo $row['BANK_REQUISITION_DATE'];
									  echo '<br>';
									  echo $row['BANK_REQUISITION_BY'];
								  }
								  else if($row['BANK_REQUISITION_STATUS']=='0'){
									   echo '<i style="color:red;"><b>Denied</b></i> ';
									   echo '<br>';
									   echo $row['BANK_REQUISITION_DATE'];
									   echo '<br>';
				...
				<?php
					...
					while($stuff)
					{
					 ...
					 echo "<script>window.location = 'http://202.40.181.98:9090/rangs_collection_rml/sc_bank_noc_received_ccd.php'</script>";
					 // END
					}
					}else{
