								...
								<div class="row">
									<div class="col-lg-12">
									   ...
									   <div class="row mt-3 mt-3 text-uppercase d-flex justify-content-center text-decoration-underline">
											<h5><b>Closing Approval Sheet(Re-Sold Vehicle)</b><h5>
									   </div>
											...
											<div class="col-sm-12 mt-2 margin-left">
											      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <b>d) Resold Received</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input style="width:40%;" type="text" id="title" form="Form2" value= "<?php echo $V_RESOLED_RECEIVED;?>" >
											</div>
											<div class="col-sm-12 mt-2 margin-left">
											      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  ...
												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  &nbsp;&nbsp;&nbsp;&nbsp;
												  <input style="width:40%;" type="text" id="title" form="Form2" value= "<?php echo $V_FRIST_PARTY_INSTALLMENT_REC+$V_RESOLED_RECEIVED;?>" >
											</div>
											<div class="col-sm-12 mt-2">
