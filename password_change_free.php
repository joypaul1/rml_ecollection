<?php 
	session_start();
	if($_SESSION['user_role_id']!= 9 && $_SESSION['user_role_id']!= 12 && $_SESSION['user_role_id']!= 5)
	{
	  ...
	  <div class="container-fluid">
			<div class="row">			
						<?php
						 ...
						 $sql = "SELECT id,user_name,emp_id,email,password,password_hint,created_date FROM tbl_users WHERE emp_id='$emp_id'";								
			...
			$sql = "update tbl_users set 
				...
				if(mysqli_query($conn,$sql)){
					...
					while($stuff)
					{
					 ...
					 echo "<script>window.location = 'http://202.40.181.98:9090/rangs_collection_rml/password_change_free.php'</script>";					
