        ...
        <div class="row">
            ...
            <div class="card rounded-4">
                ...
                if (isset($_POST['ref_id'])) {
                    ...
                    if (isset($row) && (is_array($row) || $row instanceof Countable) && count($row) > 0) {
                        ?>
                        <div class="card-body">
                            <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                                <div class="row justify-content-center align-items-center">
                    ...
                    <?php }else{
                        echo "<div class='text-center fw-bold  text-danger p-5'>Sorry! Data Not Found. </div>";
                    }
                } ?>
            </div><!--end row-->
