					...
					<div class="row">
						<div class="col-sm-3">
							...
							<select required="" name="user_type" class="form-control">
								...
								<option <?php echo isset($_POST['user_type']) ? $_REQUEST['user_type'] == 'C-C' ? 'selected' : '' : '' ?> value="C-C">Collection -
									Collection</option>
								<option <?php echo isset($_POST['user_type']) ? $_REQUEST['user_type'] == 'S-C' ? 'selected' : '' : '' ?> value="S-C">Sales - Collection
								</option>
							</select>
							...
							<table id="mainTable" class="small table-bordered">
								<thead class="bg-light">
									...
									<tr style="width:100%" class="table-danger">
										...
										<th scope="col">
											<center>Collection<br>[MM]</center>
										</th>
										<th scope="col">
											<center>Total Target<br>(Current Month)</center>
										</th>
									</tr>
								</thead>
								<tbody>
						...
						<div class="resume-item d-flex flex-column flex-md-row">
							<table id="mainTable" class="small table-bordered">
								...
								<tbody>
									...
									$strSQL = oci_parse(
										$objConnect,
										"SELECT  K.ZONE_NAME,RML_COLL_SUMOF_TARGET(K.ZONE_HEAD,'$v_start_date','$v_end_date') TARTET_AMOUNT,
