			...
			<div class="row">
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input name="ref_code" form="Form1" class="form-control" type='text'
									value='<?php echo isset($_POST['ref_code']) ? $_POST['ref_code'] : ''; ?>' />
							</div>
						</div>
						<div class="col-sm-4">
							<label for="title">&nbsp;</label>
							<input class="form-control btn btn-primary" type="submit" value="Search Approval Data"
								form="Form1">
						</div>
					</div>
				...
				<div class="col-lg-12">
					<form id="Form1" action="" method="post">
								...
								<table class="table table-bordered piechart-key" id="admin_list" style="width:100%">
									<thead class="thead-dark">
										<tr>
											...
											<th scope="col">
												<center>Eng No</center>
											</th>
											<th scope="col">
												<center>Chassis No</center>
											</th>
											<th scope="col">
						...
						and A.CODE='$ref_code'
						AND A.CCD_APPROVAL_STATUS=1
						AND A.LEASE_APPROVAL_STATUS IS NULL"
											);
											...
											<tr>
												...
												<td>
													<input class="btn btn-primary btn pull-right" type="submit"
														name="submit_approval" value="Accept" />
												</td>
												<td></td>
												<td></td>
												<td></td>
												...
												<td>
													<input class="btn btn-primary btn pull-right" type="submit"
														name="submit_denied" value="Save & Denied" />
												</td>
											</tr>
											<?php
										} else {
						...
						foreach ($_POST['check_list'] as $TT_ID_SELECTTED) {
							$strSQL = oci_parse(
								...
								"update RML_COLL_CCD_REISSUED set 
											    LEASE_APPROVAL_STATUS=1,
												LEASE_APPROVED_BY='$emp_session_id',
												LEASE_APPROVED_DATE=SYSDATE
							...
							echo "<script>window.location = 'http://202.40.181.98:9090/rangs_collection_rml/reissues_approval_lease.php'</script>";
							// END
