			...
			<div class="row">
				...
				$strSQL = oci_parse(
					...
					"SELECT ID,
								...
								RESOLED_DP,
								RESOLED_RECEIVED,
                            	-- JOY ADD REF CODE (select AA.TOTAL_RECEIVED_AMOUNT from LEASE_ALL_INFO_ERP AA WHERE AA.CHASSIS_NO= DD.CHASSIS_NO AND AA.PAMTMODE=DD.SALE_TYPE and AA.REF_CODE= DD.REF_CODE and rownum=1) RESOLED_RECEIVED,
										...
										<div class="row">
											<div class="col-sm-12 input-lg">
												<b>01. RML Code
													No:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input style="width:70%;" type="text" id="title"
													value="<?php echo $row['REF_CODE']; ?>" readonly>
											</div>
											<div class="col-sm-12 mt-3 input-lg">
												<b>02. Customer Name</b>(First
												Party):&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input style="width:70%;" type="text" name="first_customer_name"
													value="<?php echo $row['FIRST_PARTY_NAME']; ?>">
											</div>
											<div class="col-sm-12 mt-3 input-lg">
												<b>03. Customer Name</b>(Current Party):&nbsp;&nbsp;&nbsp;&nbsp;
												<input class="input-lg" style="width:70%;" type="text"
											...
											<div class="col-sm-12 mt-3 input-lg">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input style="width:70%;" type="text" name="current_customer_mobile"
											...
											<div class="col-sm-12 mt-3 input-lg">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input style="width:70%;" type="text" name="model_name"
											...
											<div class="col-sm-12 mt-3 margin-left">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;
												<input style="width:50%;" type="text" name="chassis_price"
											...
											<div class="col-sm-12 mt-3 margin-left">
												...
												<b>ii) 1st Party DP
													Received</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input style="width:50%;" type="text" name="first_party_dp"
													value="<?php echo $row['FIRST_PARTY_DP_RECEIVED']; ?>">
											</div>
											<div class="col-sm-12 mt-3 margin-left">
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<b>iii) 1st Party EMI
													Received</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input style="width:50%;" type="text" name="first_total_received"
											...
											<div class="col-sm-12 mt-3 margin-left">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input style="width:50%;" type="text" name="resold_dp"
											...
											<div class="col-sm-12 mt-3 margin-left">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;
												<input style="width:50%;" type="text" name="receivable"
											...
											<div class="col-sm-12 mt-3 margin-left">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input style="width:50%;" type="text" name="discount"
											...
											<div class="col-sm-12 mt-3 margin-left">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;
												<input style="width:50%;" type="text" name="received"
											...
											<div class="col-sm-12 mt-3 margin-left">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input style="width:50%;" type="text" name="closing_fee"
											...
											<div class="col-sm-3">
												<div class="form-group">
													...
													<input class="form-control" type="text"
														value="<?php echo $row['RESALE_APPROVAL_DATE']; ?>" readonly />
												</div>
											</div>
										...
										<div class="row">
											<div class="col-sm-3">
												<div class="form-group">
													...
													<input type="text" class="form-control"
														value="<?php echo $row['CHASSIS_NO']; ?>" readonly>
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="title"
														value="<?php echo $row['ENG_NO']; ?>" readonly>
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="title"
														value="<?php echo $row['REG_NO']; ?>" readonly>
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													...
													<input type="text" class="form-control"
														value="<?php echo $row['CLOSING_DATE']; ?>" readonly>
												</div>
											</div>
											...
											if ($_SESSION['user_role_id'] == 2 || $_SESSION['user_role_id'] == 9) {
												...
												<div class="col-sm-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" id="title" name="lease_ramarks"
															value="<?php echo $row['LEASE_REMARKS']; ?>">
													</div>
												</div>
												<?php
											} else {
												...
												<div class="col-sm-12">
													<div class="form-group">
														<label for="title">Lease Remarks:</label>
														<input type="text" class="form-control" id="title" name="lease_ramarks"
															value="<?php echo $row['LEASE_REMARKS']; ?>" readonly>
													</div>
												</div>
												<?php
											}
											...
											if ($_SESSION['user_role_id'] == 12) {
												...
												<div class="col-sm-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" id="title"
															name="accounts_ramarks"
															value="<?php echo $row['ACCOUNTS_REMARKS']; ?>">
													</div>
												</div>
												<?php
											} else {
												...
												<div class="col-sm-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" id="title"
															name="accounts_ramarks"
															value="<?php echo $row['ACCOUNTS_REMARKS']; ?>" readonly>
													</div>
												</div>
												<?php
											}
											...
											<div class="row">
												...
												<div class="col-sm-4">
													<div class="form-group">
														...
														<select required="" name="sc_lease_approval_status"
															class="form-control">
															<option value="">--</option>
