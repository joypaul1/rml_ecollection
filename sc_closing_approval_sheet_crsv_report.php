    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="">Closing Approval Sheet(CRSV)</a>
        </li>
      </ol>
	  ...
	  <div class="container-fluid">
            ...
            <?php
			     ...
			     $strSQL  = oci_parse($objConnect, "SELECT 
									   ...
									   FIRST_PARTY_NAME, 
									   --FIRST_PARTY_DP, 
									   (SELECT NVL2(REGULAR_REFCODE,TOTAL_DP_RCV,0) FROM FILESUM_ERP WHERE RE_SALE_REFCODE=REF_CODE) FIRST_PARTY_DP,
                 ...
                 while($row=oci_fetch_assoc($strSQL)){					
					 $V_REF_CODE=$row['REF_CODE']; 
						...
						$CURRENT_PARTY_DP_RECEIVED=$row['CURRENT_PARTY_DP_RECEIVED']; 
						   ...
						   <div class="col-lg-12 border border border-dark">
								...
								<div class="row">
									<div class="col-lg-12">
									    ...
									    <div class="row mt-2 text-uppercase d-flex justify-content-center">
									   ...
									   <div class="row mt-3 text-uppercase d-flex justify-content-center text-decoration-underline">
											<h5><b>Closing Approval Sheet(Credit Re-Sold Vehicle)</b><h5>
									   </div>
											...
											<div class="col-sm-12 mt-2">
												  ...
												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  &nbsp; &nbsp;&nbsp; &nbsp;
												<textarea  rows="2" style="width:40%;"><?php echo $V_CURRENT_PARTY_ADDRS;?></textarea>
											</div>
											...
											<div class="col-sm-12 mt-2 margin-left">
												  ...
												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  &nbsp;&nbsp;&nbsp;
												  <input style="width:40%;" type="text" id="title" form="Form2" value= "<?php echo $V_SALES_AMOUNT;?>" >
											</div>
											
											<div class="col-sm-12 mt-2 margin-left">
											      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <b>b) 1st Party Down Payment</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input style="width:40%;" type="text" id="title" form="Form2" value= "<?php echo $V_FIRST_PARTY_DP;?>">
											</div>
											<div class="col-sm-12 mt-2 margin-left">
											      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <b>c) 1st Party Installment</b>:
												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input style="width:40%;" type="text" id="title" form="Form2" value= "<?php echo $V_FRIST_PARTY_INSTALLMENT_REC;?>" >
											</div>
											<div class="col-sm-12 mt-2 margin-left">
											      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <b>d) Resold Down Payment</b>:
												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input style="width:40%;" type="text" id="title" form="Form2" value= "<?php echo $CURRENT_PARTY_DP_RECEIVED;?>" >
											</div>
											<div class="col-sm-12 mt-2 margin-left">
											      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <b>e) 2nd Party Installment</b>:
												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input style="width:40%;" type="text" id="title" form="Form2" value= "<?php echo $V_INSTALLMENT_RECEIVED;?>" >
											</div>
											<div class="col-sm-12 mt-2 margin-left">
											      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <b>f) Total Received</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  &nbsp;&nbsp;&nbsp;&nbsp;
												  <input style="width:40%;" type="text" id="title" form="Form2" 
												  value= "<?php echo $V_FRIST_PARTY_INSTALLMENT_REC+$CURRENT_PARTY_DP_RECEIVED+$V_FIRST_PARTY_DP+$V_INSTALLMENT_RECEIVED;?>" >
											</div>
											<div class="col-sm-12 mt-2">
											...
											<div class="col-sm-12 mt-2">
												  <b>09. Resale Approval Date:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $V_RESALE_APPROVAL_DATE;?></b>
											</div>
											 <div class="col-sm-12 mt-3">
												  <b>10. Lease Remarks:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $LEASE_REMARKS;?></b>
											</div>
											<div class="col-sm-12 mt-3">
												  <b>11. Account Remarks:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $ACCOUNTS_REMARKS;?></b>
											</div>
