										...
										<div class="row">
											...
											<div class="col-sm-3">
												<div class="form-group">
												  ...
												  <input type="text" name="emp_form_name" class="form-control" id="title"  value= "<?php echo $row['EMP_NAME'];?>">
												</div>
											</div>
											...
											<div class="col-sm-3">
												<div class="form-group">
												  ...
												  <input type="text" name="emp_mobile_no" class="form-control" id="title" value= "<?php echo $row['MOBILE_NO'];?>" >
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
