						...
						<div class="md-form mt-2">
							...
							<div class="row canvas_div_pdf" id="printableArea">
								<div class="col-lg-12">
									...
									<div class="row mt-3 text-uppercase d-flex justify-content-center">
										<center>[মোটরযান অধ্যাদেশ ১৯৮৩-এর ৪০(১) ধারা এবং মোটরযান বিধি ১৯৮৪-এর ৬৪(১)
											বিধি]<br>মোটরযানের মালিকানা বদলির তথ্য</center>
									</div>
									<br>


									<div class="row mt-2 d-flex justify-content-left">
										<p style="font-family:Times New Roman;">আমি /আমরা
											-<?php echo ' ' . $V_CURRENT_PARTY_NAME; ?></p>
									</div>
									<div class="row d-flex justify-content-left">
										<p style="font-family:Times New Roman;"> পিতা / স্বামী -
											<?php echo '' . $V_FATHER_OR_HUSBAND_NAME . ' '; ?> </p>
									</div>
									<div class="row d-flex justify-content-left">
										<p style="font-family:Times New Roman;"> ঠিকানা -
											<?php echo '' . $V_CURRENT_PARTY_ADDRS . ' '; ?> </p>
									</div>
									<div class="row d-flex justify-content-left">
										<p style="font-family:Times New Roman;"> এতদসঙ্গে গাড়ি নং -
											<?php echo '' . $V_REG_NO . ' '; ?></p>
									</div>
									<div class="row d-flex justify-content-left">
										<p style="font-family:Times New Roman;"> ধরন--------------------------------,
											প্রস্তুতকাল/প্রস্তুতকারক------------------এর</p>
									</div>
									<div class="row d-flex justify-content-left">
										<p style="font-family:Times New Roman;"> ইঞ্জিন নং -<?php echo ' ' . $V_ENG_NO; ?></b>
										</p>
									</div>
									<div class="row d-flex justify-content-left">
										<p style="font-family:Times New Roman;"> চেসিস নং
											-<?php echo ' ' . $V_CHASSIS_NO; ?></b></b></p>
									</div>
									<div class="row d-flex justify-content-left">
										<p style="font-family:Times New Roman;"> রেজিস্ট্রেশন সার্টিফিকেট এবং ফিটনেস
											সার্টিফিকেট,রুট পারমিট টেক্সটোকেন এবং ইন্সুরেন্স সার্টিফিকেট সংযুক্ত করিয়া
											জনাব---------------------------------------------</b></b></p>
									</div>
									<div class="row d-flex justify-content-left">
										<p style="font-family:Times New Roman;"> পিতা / স্বামী
									...
									<div class="row d-flex justify-content-left">
										<p style="font-family:Times New Roman;">কতৃক আমি/আপনার নিকট হস্তান্তরকৃত উপরে
											উল্লেখিত গাড়ীটির নাম মালিকানা আমি আমাদের অনুকূলে বদলি তথা (রেজিস্ট্রেশন )করিবার
											অনুরোধ জানাইতেছি।</b></b></p>
									</div>
									...
									<div class="col-sm-12">
										<div class="col-sm-12">
											<p>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;হস্তান্তরকারী
												গৃহীতার (ক্রেতা) স্বাক্ষর : <br>
												&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ভাড়া
												খরিদ/দায়বদ্ধ মালিকের স্বাক্ষর
											</p>
										</div>
									</div>
