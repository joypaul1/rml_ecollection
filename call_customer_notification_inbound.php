				...
				<div class="col-lg-12">
				    <form action="" method="post">
						<div class="row">
							...
							<div class="col-sm-3">
							    <label for="title">Follow-Up Start Date:</label>
						...
						if(isset($_POST['followup_date'])){
						 ...
						 <?php
						     ...
						     $allDataSQL  = oci_parse($objConnect, 
							       "select (select CALL_CATEGORY_TITLE from RML_COLL_CALL_CATEGORY where id=a.RML_COLL_CALL_CATEGORY_ID)RML_COLL_CALL_CATEGORY,
								   count(a.ID) TOTAL_NUMBER,b.FOLLOW_UP_DATE FOLLOW_UP_DATE,RML_COLL_CALL_CATEGORY_ID
								   from CCD_CALL a,CCD_CALL_FOLLOWUP b
								where a.id=b.CCD_CALL_ID
								and b.CLOSE_STATUS=0
