    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="">Ownership Transfer Of Vehicle</a>
        </li>
      </ol>
			 ...
			 $strSQL  = oci_parse($objConnect,"SELECT 
				...
				?>   	   
						   ...
						   <div class="col-lg-12 border border border-dark">
								...
								<div class="row canvas_div_pdf" id="printableArea">
									<div class="col-lg-12">
									   ...
									   <p style="font-family:Times New Roman;">
									    ...
									    <br> <br>
									    <div class="row d-flex justify-content-left" style="font-family:Times New Roman;">
											Dated: <?php echo ' '.$V_SYSDATE;?>
									    </div>
										<div class="row d-flex justify-content-left" style="font-family:Times New Roman;">
										...
										<div class="row d-flex justify-content-left" style="font-family:Times New Roman;">
											<?php echo '  '.$V_BRTA_LOCATION;?>
									    </div><br>
										<div class="row mt-2 d-flex justify-content-left">
										    <p style="font-family:Times New Roman;">Ref:&nbsp;&nbsp; <b><?php echo '  '.$V_REF_CODE;?></b></p>
									    </div>
										<br>
										<div class="row mt-2 d-flex justify-content-left">
										    <u style="font-family:Times New Roman;"><b>Subject: Ownership Transfer Of Vehicle.</b></u>
									    </div>
										<div class="row mt-2 d-flex justify-content-left" style="font-family:Times New Roman;">
											Dear sir, 
									    </div>
										<div class="row mt-2 d-flex justify-content-left" style="font-family:Times New Roman;">
										  We have the honor to state that we sold 01(one) unit of &nbsp;<b><?php echo '  '.$V_MODEL_NAME.'  ';?></b>&nbsp;bearing,
								   ...
								   <div class="row d-flex justify-content-left" style="font-family:Times New Roman;">
									<b>
									Registration No.: <?php echo ' '.$V_REG_NO;?>
                                    </b>
									</div>
								   ...
								   <div class="row d-flex justify-content-left" style="font-family:Times New Roman;">
									<b>
									Chassis No.: <?php echo $V_CHASSIS_NO;?>
                                    </b>
									</div>
								   <div class="row mt-2 d-flex justify-content-left" >
								     <p style="font-family:Times New Roman;">
								      <?php 
									  echo 'To : <b>'.$V_CURRENT_PARTY_NAME.',</b>&nbsp;'.$V_CUSTOMER_SO.', Add: '.$V_CURRENT_PARTY_ADDRS;?>
									  </p>
									</div>
								<br>
								<br>
                               ...
                               <div class="row mt-2 d-flex justify-content-left">
									<p style="font-family:Times New Roman;">
									We would therefore, request you to kindly transter the ownership to the same and oblige thereby.</p>
								</div>

								<div class="row mt-2 d-flex justify-content-left">
									<p style="font-family:Times New Roman;">
									Thaking you,<br>Yours Faithfully.</p>
								</div>
								<br>  
								...
								<div class="row" style="font-family:Times New Roman;">
								  ...
								  <br>
								  <b>---------------------------<br>
								  <?php echo ' '.$V_RESPONSIBLE_PERSON;?><br>
								  <?php echo ' '.$V_RESPONSIBLE_DESIGNATION;?><br>
								  Rangs Motors Limited</b>
