									...
									<form action="" method="post">
										<div class="row">
											...
											<div class="col-sm-12 mt-3 input-lg">
												...
												<input class="input-lg" style="width:70%;" type="text"
													name="current_customer_so" value="<?php echo $row['CUSTOMER_SO']; ?>">
											</div>
											<div class="col-sm-12 mt-3 input-lg">
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<b> পিতা/স্বামী :</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											...
											<div class="col-sm-12 mt-3 margin-left">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;
												<input style="width:50%;" type="text" value="<?php echo $row['RESOLED_RECEIVED'] + $row['FIRST_PARTY_DP'] +
										...
										<div class="row mt-2">
											...
											<div class="col-sm-4">
												...
												<select name="responsible_concern" class="form-control"> RESPONSIBLE_PERSON
													<option value="Lt. Col. Shaikh Abidur Rahman">Lt. Col. Shaikh Abidur
														Rahman</option>
													<option value="Golam M Sayeem">Golam M Sayeem</option>
													<option value="Mirza Md. Ahsan Reza Kader Boksh">Mirza Md. Ahsan Reza
														Kader Boksh</option>
													...
													<option selected value="<?php echo $row['RESPONSIBLE_PERSON']; ?>">
														<?php echo $row['RESPONSIBLE_PERSON']; ?></option>
												</select>
											</div>
											...
											<div class="col-sm-4">
												...
												<select name="responsible_designation" class="form-control">
													...
													<option selected value="<?php echo $row['RESPONSIBLE_DESIGNATION']; ?>">
														<?php echo $row['RESPONSIBLE_DESIGNATION']; ?></option>
												</select>
											</div>
														...
														while ($row_bank = oci_fetch_assoc($strSQL)) {
															if ($row['BANK_ID'] == $row_bank['ID']) {
																...
																<option selected value="<?php echo $row_bank['ID']; ?>">
																	<?php echo $row_bank['BANK_NAME']; ?></option>
																<?php
															} else {
																?>
