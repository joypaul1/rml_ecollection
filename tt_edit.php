			...
			<div class="row">
				<div class="col-lg-12">
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="row">
											...
											<div class="col-sm-3">
												<div class="form-group">
												  ...
												  <input type="text" name="tt_changed_amount" class="form-control" id="title" value= "<?php echo $row['AMOUNT'];?>"  form="Form2">
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
												   <label for="title">Total TT Amount:<font color="red">**</font> </label>
												  <input type="text" name="total_tt_amount" class="form-control" id="title" value= "<?php echo $row['TT_TOTAL_TAKA'];?>"  form="Form2">
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-sm-3">
												<div class="form-group">
												  ...
												  <input required="" type="text" name="tt_changed_branch" class="form-control" id="title" value= "<?php echo $row['TT_BRANCH'];?>" form="Form2">
												</div>
											</div>
											...
											<div class="col-sm-3">
												<div class="form-group">
												  ...
												  <input required="" type="text" name="tt_remarks" class="form-control" id="title" value= "<?php echo $row['TT_REMARKS'];?>" form="Form2">
												</div>
											</div> 
											<div class="col-sm-3">
												<div class="form-group">
												    <label for="title">Changed TT Date:<font color="red">**</font> </label>
												  <input required="" type="date" name="tt_changed_date" class="form-control" id="title" form="Form2">
												</div>
											</div> 
										</div>
										...
										<div class="row">
											<div class="col-sm-3">
												<div class="form-group">
												  <label for="title">New TT Type:<font color="red">**</font> </label>
												  <select required="" name="new_tt_type" class="form-control" form="Form2">
														 <option selected value="">Select TT Type</option>
											...
											<div class="col-sm-3">
												<div class="form-group">
												  <label for="title"><font color="red">TT File Close Amount:</font> </label>
												   <input type="text" name="tt_file_close_amount"  class="form-control" id="title"  form="Form2">
												</div>
											</div>
					
											<div class="col-sm-3">
												<div class="form-group">
												  <label for="title"> <font color="red">TT Due Amount:</font> </label>
												  <input type="text" name="tt_due_amount" class="form-control" id="title"  form="Form2">
												 
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
												   <label for="title">Change Remarks:<font color="red">**</font> </label>
										...
										<div class="row">
											 <div class="col-lg-12">
												...
												<button type="submit" name="submit" class="form-control btn btn-primary" form="Form2">Submit To Update</button>
												</div>
										     </div>	
										</div>
									</div>
	              ...
	              <?php
                          ...
                          @$new_tt_type = $_REQUEST['new_tt_type'];
