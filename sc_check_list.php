						...
						<thead class="thead-dark">
								<tr>
								  ...
								  <th scope="col">Customer Info</th>
								   <th scope="col">Lease Approval</th>
								  <th scope="col">Acc Approval</th>
								  <th scope="col">CCD Accept</th>
						   ...
						   <tr>
							...
							<td>
							    <?php 
								 ...
								 echo '<br>';
								 echo "<u>Name: </u>".$row['CURRENT_PARTY_NAME'];
								 echo '<br>';
								 echo "<u>Mobile: </u>".$row['CURRENT_PARTY_MOBILE'];
								 echo '<br>';
							...
							<td>
							 ...
							 <td>
							    <?php 
								 ...
								 echo '<br>';
								 echo "<u>Mobile: </u>".$row['REQUESTER_MOBILE'];
								 echo '<br>';
								 echo "<u>Created: </u>".$row['REQUEST_DATE'];
								?>
							</td>
							<td align="center">
						   ...
						   <tr>
							...
							<td>
							    <?php 
								 ...
								 echo "<u>Mobile: </u>".$row['CURRENT_PARTY_MOBILE'];
								 echo '<br>';
								 echo '<i style="color:gray;"><b><u> Sale Type: </u>'.$row['SALE_TYPE'].'</b></i> ';
								?>
							</td>
