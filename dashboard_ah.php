					...
					<div class="resume-item d-flex flex-column flex-md-row">
						...
						<thead class="bg-light">
								...
								<tr  style="width:100%" class="table-danger">
								  ...
								  <th scope="col"><center>Collection<br>[MM]</center></th>
								  <th scope="col"><center>Total Target<br>(Current Month)</center></th>
								 </tr>
					   </thead>
					    <tbody>
						<?php   
    //echo $USER_ID;		
                        $myQuery="SELECT K.ZONE_NAME,RML_COLL_SUMOF_TARGET(K.ZONE_HEAD,'$v_start_date','$v_end_date') TARTET_AMOUNT,
								   ...
								   AND K.AREA_HEAD=$USER_ID
								ORDER BY K.ZONE_NAME";	
								//echo $myQuery;
						 $strSQL  = oci_parse($objConnect, $myQuery);
		                  ...
		                  while($row=oci_fetch_assoc($strSQL)){	
						   ...
						   <tr>
							 ...
							 <td align="center">
                              ...
                              <td align="right"><?php echo number_format($row['MM_TOTAL'],2); $MM_TOTAL= $MM_TOTAL+$row['MM_TOTAL'];?></td>
							  <td align="right"><?php echo  number_format($row['TARTET_AMOUNT'],2); $MM_TARGET_TOTAL= $MM_TARGET_TOTAL+$row['TARTET_AMOUNT'];?></td>
						 </tr>
						 <?php
		                 }
						 ?>
						 <tr class="p-3 mb-2 bg-success text-white">
							  ...
							  <td align="center"><?php echo number_format($MM_TOTAL,2); ?></td>
							 <td align="center"><?php echo number_format($MM_TARGET_TOTAL,2); ?></td>
						 </tr>
					    </tbody>	
					...
					<div class="resume-item d-flex flex-column flex-md-row">
						...
						<thead class="bg-light">
								...
								<tr class="table-danger"  style="width:100%">
								  ...
								  <th scope="col">Zonal Head</th>
								  <th scope="col"><center>Collection Total</center></th>
								  <th scope="col"><center>Truck Total</center></th>
								  <th scope="col"><center>Bus Total</center></th>
								  <th scope="col"><center>Others Total</center></th>
								 </tr>
					   </thead>
					    <tbody>
						<?php    
						 $strSQL  = oci_parse($objConnect, 
						        "SELECT 
								    K.ZONE_NAME,RML_COLL_SUMOF_TARGET(K.ZONE_HEAD,'$v_start_date','$v_end_date') TARTET_AMOUNT,
		                  ...
		                  while($row=oci_fetch_assoc($strSQL)){	
						   ...
						   <tr>
							  ...
							  <td><?php echo $row['ZH_NAME']; ?></td>
							  <td align="center"><?php echo $row['EICHER_TOTAL']; $EICHER_TOTAL= $EICHER_TOTAL+$row['EICHER_TOTAL'];?></td>
                              <td align="center"><?php echo $row['TRUCK_TOTAL']; $TRUCK_TOTAL= $TRUCK_TOTAL+$row['TRUCK_TOTAL']; ?></td>
                              <td align="center"><?php echo $row['BUS_TOTAL'];$BUS_TOTAL=$BUS_TOTAL+$row['BUS_TOTAL']; ?></td>
                              <td align="center"><?php echo $row['OTHERS_TOTAL']; $OTHERS_TOTAL=$OTHERS_TOTAL+$row['OTHERS_TOTAL'];?></td>
						 </tr>
						 <?php
		                 }
						 ?>
						 <tr class="p-3 mb-2 bg-success text-white">
							  ...
							  <td align="center"></td>
							  <td align="center">Total=</td>
							  <td align="center"><?php echo $EICHER_TOTAL; ?></td>
							  <td align="center"><?php echo $TRUCK_TOTAL; ?></td>
							  <td align="center"><?php echo $BUS_TOTAL; ?></td>
							  <td align="center"><?php echo $OTHERS_TOTAL; ?></td>
						 </tr>
					    </tbody>	
