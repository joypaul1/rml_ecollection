				...
				<div class="col-lg-12">
					<form action="" method="post">
						<div class="row">
							...
							<div class="col-sm-3">
								<label for="title"><b>TT Create Start Date:</b><sup style="color:red;">*</sup></label>
							...
							<div class="col-sm-3">
								<label for="title"><b>TT Create End Date:</b><sup style="color:red;">*</sup></label>
								<div class="input-group">
									<div class="input-group-addon">
										<i class="fa fa-calendar">
										</i>
							...
							<div class="col-sm-3">
								...
								<select name="concern_zone" class="form-control">
									...
									while ($row = oci_fetch_assoc($strSQL)) {
										?>
										<option value="<?php echo $row['ZONE_NAME']; ?>"><?php echo $row['ZONE_NAME']; ?>
										</option>
										<?php
									}
									?>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="md-form mt-3">
									<input class="btn btn-primary btn pull-right form-control" type="submit"
                        ...
                        AND TRUNC(a.CREATED_DATE) >=TO_DATE('02/01/2020','dd/mm/yyyy')"
											...
											while ($row = oci_fetch_assoc($strSQL)) {
												...
												<tr>
													...
													<td align="center">
														<?php echo $row['AMOUNT'];
														$grandTotaEMI_TT = $grandTotaEMI_TT + $row['AMOUNT'];
														?>
													</td>
													<td align="center">
														<?php echo $row['TT_TOTAL_TAKA'];
														$grandTotaEMI_TOTAL_TT = $grandTotaEMI_TOTAL_TT + $row['TT_TOTAL_TAKA'];
														?>
													</td>
